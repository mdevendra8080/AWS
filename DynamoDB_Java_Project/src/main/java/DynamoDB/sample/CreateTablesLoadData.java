...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "ProductCatalogDM";
    static String forumTableName = "ForumDM";
    static String threadTableName = "ThreadDM";
    static String replyTableName = "ReplyDM";
